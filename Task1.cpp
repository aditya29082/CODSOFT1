...
std::srand(std::time(0));
    ...
    int AnyNumber = std::rand() % 100 + 1;
     ...
     int attempts =0;
      ...
      std::cout<<"hello jarvis please Enter a number between 1 to 100.\n";
        

      do{
        std::cout<<"Hello jarvis! Insert your guess:";
        std::cin>> youGuess;

         if(youGuess< AnyNumber) {
          std::cout<<"To low! hey jarvis  please think high\n";
         } else if (youGuess >AnyNumber){
          std::cout<<"To high! hey jarvis please think low\n";
         }
         attempts++;

         } while (youGuess != AnyNumber);
         std::cout<<"congratulation jarvis you guessed the number in " << attempts <<"guesses\n";
         return 0;
